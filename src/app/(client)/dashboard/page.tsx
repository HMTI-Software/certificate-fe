...
const page = () => {
  ...
  return (
    <div className="w-full px-40 min-h-screen 2xl:px-80">
      <Navbar />
      <div
        className={
          isPremium
      ...
      >
        {isPremium ? (
          <div className="w-full grid grid-cols-3 pt-8 gap-4">
            ...
            <Link href="/dashboard/create" className="py-20 rounded-md bordered border-b-4 hover:border-b cursor-pointer">
