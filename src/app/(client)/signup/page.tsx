      ...
      <div className="min-w-md flex flex-col border-black p-4 rounded-lg items-center">
        <form action="" className="w-full max-w-sm flex flex-col gap-4">
          <div className="mb-6">
            ...
            <p>tolong membuat akun untuk melanjutkan</p>
          </div>
              ...
              {field.type === "password" ? (
                <div className="flex-col flex gap-2">
                  <div className="flex gap-2 items-stretch">
                    <input type={ field.eyeId == 1 ? showPassword ? "text" : "password" : showPasswordConfirmation ? "text" : "password" } name={field.id} className="bordered rounded-md w-full" id={field.id} placeholder={field.placeholder} />
                    <div onClick={() => {openPassword(field.eyeId)}} className="bg-purplee h-full aspect-square bordered rounded-md flex justify-center items-center">
                      <Eye/>
                    </div>
                  </div>
                </div>
