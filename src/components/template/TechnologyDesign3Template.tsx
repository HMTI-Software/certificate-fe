...
export const TechnologyDesign3Template = ({ eventData }: Props) => {
  return (
    <div className="relative mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
      ...
      />
      {/* HEADER */}
      <div className="absolute inset-0 top-2 flex items-start justify-center w-full h-full ">
        <h1 className="text-[13px] font-light text-white text-center">
          <span>{eventData.eventCertificatePrefixCode}preview</span>
        </h1>
      </div>

      {/* CONTENT */}
      <div className="absolute inset-0 top-16 flex flex-col justify-center items-center w-full h-full space-y-3 text-white">
      ...
      {/* FOOTER */}
      <div className="absolute inset-0 -top-5 flex flex-col justify-end items-center w-full h-full space-y-1 text-white">
