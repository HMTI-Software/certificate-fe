...
export const FormalDesign1Template = ({ eventData }: Props) => {
  return (
    <div className="relative mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
      ...
      {/* FOOTER */}
      <div className="absolute inset-0 -top-10 flex flex-col justify-end items-center w-full h-full space-y-1 ">
