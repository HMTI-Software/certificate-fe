    ...
    <div className="w-full fixed top-0 left-0 z-50 white backdrop-blur-xl h-screen flex justify-center items-center">
      <div className="gap-4 bg-white w-full max-w-3xl mx-auto rounded-md flex flex-col bordered-nonhover px-3">
        ...
        <form
          ...
          className="w-full justify-between flex flex-col md:flex-row gap-2 items-stretch"
        >
          <div className="flex-1 gap-2 flex flex-col">
            ...
            <input
              type="file"
              name="file_name"
              className="bordered bg-white w-full rounded-md"
            />
          </div>
            ...
            <div className="w-full">
              {Array.from({ length: participantCounter }, (_, i) => (
                <div className="flex items-stretch gap-2" key={i}>
                  ...
                  />
                  <button
                    className="bordered bg-redd aspect-square rounded-md flex items-center justify-center"
                    onClick={(e) => {
                      e.preventDefault();
                      setParticipantCounter(participantCounter - 1);
                    }}
              ...
              <div className="w-full flex justify-end pt-2 gap-2">
                <button
                  onClick={addParticipantHandle}
                  className="flex-1 bordered bg-yelloww justify-center rounded-md flex gap-1 items-center"
                >
                  <Plus size={16} /> add participant
                </button>
                <button
                  type="submit"
                  className="flex-1 bordered bg-greenn justify-center rounded-md flex gap-1 items-center"
                >
                  <Send size={16} /> submit
                </button>
              </div>
