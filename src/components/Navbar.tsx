    ...
    <div className="w-full py-4 bg-white">
      <div className="w-[1206px] inline-flex justify-between items-center">
        <div className="flex-1 inline-flex flex-col justify-start items-start">
          <div className="justify-start text-black text-lg font-bold font-['Plus_Jakarta_Sans']">Dashboard</div>
          <div className="w-64 justify-start text-grayy text-sm font-normal font-['Plus_Jakarta_Sans']">hi Alif, such a nice day to see you</div>
        </div>
        <div className="flex-1 self-stretch flex justify-center items-center gap-10">
          {NavMenu.map((item) => (
            <Link href={item.link} key={item.id} className="text-sm group relative w-max">
